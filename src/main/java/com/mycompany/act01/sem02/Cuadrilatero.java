...
public abstract class Cuadrilatero extends FiguraGeometrica {
    ...
    private boolean escalarProducto(Punto p1, Punto p2, Punto punto3) {
        return (punto3.getCoordenada_y() - p1.getCoordenada_y()) * (p2.getCoordenada_y() - p1.getCoordenada_y())
                + (punto3.getCoordenada_x() - p1.getCoordenada_x()) * (p2.getCoordenada_x() - p1.getCoordenada_x()) == 0;
    }
